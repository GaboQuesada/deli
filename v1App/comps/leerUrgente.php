        ...
        <div class="container">
            <div class="boxcontenthi slideDown">
                ...
                <div>
                    ...
                    <div class="boxtitle"><h3>Sabes eres parte de mi historia !!! </h3></div>
                </div>
                <center>
                    <img src="../img/adri.jpg" width="250" height="250" />
                </center>
                <ul>
                    <li class="itembox" ><i class="fas fa-clipboard-check" ></i>&numsp;No se por cuanto tiempo mas .</li>
                    <li class="itembox" ><i class="fas fa-clipboard-check" ></i>&numsp;O que lugar llegues a ocupar.</li>
                    <li class="itembox" ><i class="fas fa-clipboard-check" ></i>&numsp;O en que nos convertiremos .</li>
                    <li class="itembox" ><i class="fas fa-clipboard-check" ></i>&numsp;pero ya eres parte de mi historia.</li>
